...
All job definitions will be moved to [app-interface](https://gitlab.cee.redhat.com/service/app-interface).

For any questions, please contact the [Red Hat App-SRE Team](sd-app-sre@redhat.com).
