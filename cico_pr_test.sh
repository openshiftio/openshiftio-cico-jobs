...
/home/devtools/venv/env/bin/jenkins-jobs test $JJB_INDEX -o $NEW_JOBS
ret=$?
...
git show origin/master:$JJB_INDEX | /home/devtools/venv/env/bin/jenkins-jobs test -o $MASTER_JOBS
